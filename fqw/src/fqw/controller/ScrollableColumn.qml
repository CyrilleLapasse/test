...
Flickable {
    ...
    default property alias elements: col.children;
    ...
    QtObject {
        ...
        function doHighlight(index)
        {
            ...
            if (index == currentIndex && item.focus) {
                //console.log(widget, index, "Current");
